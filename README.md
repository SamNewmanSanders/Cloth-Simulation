This project was to test if my basic Render engine(? if it can be called that) that I created for the Learning opengl repo could actually be used in another project.
